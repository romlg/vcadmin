...
<script src="/js/restorefacsimileaccounts.js" type="text/javascript"></script>

<body>
<form:form name="aspnetForm" method="post" action="RestoreFacsimileAccounts" id="aspnetForm" class="cssform">
    ...
    <div class="mainContainer">
        ...
        <table class="searchtable" cellspacing="0" cellpadding="4">
            <tr>
                <th colspan="4">
                    <span style="color: #FFF; font-weight: bold; text-align: left;">Restore V-Cash Accounts</span>
                </th>
            </tr>
            <tr>
                <td>
                    ...
                    <table class="searchtable" cellspacing="0" cellpadding="4">
                            ...
                            <td colspan="2">
                                <div>
                                    <table class="mGrid" cellspacing="0" cellpadding="3" rules="rows" border="1"
                                           id="ctl00_mainContent_gvRestoreAccountsView"
                                           style="width:100%;border-collapse:collapse;">
                                        <tr>
                                            <th scope="col">
                                                <input id="ctl00_mainContent_gvRestoreAccountsView_ctl01_chkParent"
                                                       type="checkbox"
                                                       name="ctl00$mainContent$gvRestoreAccountsView$ctl01$chkParent"/>
                                            </th>
                                        ...
                                        <c:forEach items="${data}" var="vfa" varStatus="loopStatus">
                                            <tr class="${loopStatus.index % 2 == 0 ? '' : 'alt'}">
                                                <td align="center" valign="top" style="white-space:nowrap;">
                                                    <input id="chkAccount_id_<c:out value="${vfa.acctId}"/>"
                                                           type="checkbox"
                                                           name="chkAccount_name_<c:out value="${vfa.affId}"/>"/>
                                                </td>
                        ...
                        <tr>
                            <td colspan="2" class="right">
                                <input type="submit" name="ctl00$mainContent$btnRevokeAccount" value="Restore Account"
                                       id="ctl00_mainContent_btnRevokeAccount" class="button_blue"
                                       onclick="return revokeAccount();"/>
                            </td>
                        </tr>
                    </table>
                </div>
